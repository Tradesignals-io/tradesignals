...
Topic configurations are stored in a separate file called `topics.yaml`.  The pipelines.yaml file references the topics.yaml file using the `Topics` property.
