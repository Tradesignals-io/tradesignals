...
from databento.common.enums import StringyMixin, coercible
...
class Venue(StringyMixin, str, Enum):
    ...
    XASE = "NYSE MKT LLC"
    ARCX = "NYSE Arca"
    XCHI = "NYSE Chicago, Inc."
    IEXG = "Investors Exchange"
    FINN = "FINRA/Nasdaq TRF Carteret"
    ...
    IFEU = "ICE Futures Europe (Commodities)"
    NDEX = "ICE Endex"
    DBEQ = "Databento Equities - Consolidated"
    SPHR = "MIAX Sapphire"
